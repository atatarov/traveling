...
/* harmony export */ });
/* harmony import */ var _utils_adapter__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils/adapter */ "./src/utils/adapter.js");
...
class ApiService {
  ...
  addEvent = async event => {
    const response = await this.#load({
      url: "points",
      method: Method.POST,
      body: JSON.stringify(_utils_adapter__WEBPACK_IMPORTED_MODULE_0__["default"].adaptEventToServer(event)),
      headers: new Headers({
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ Destinations)
/* harmony export */ });
/* harmony import */ var _utils_adapter__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/adapter */ "./src/utils/adapter.js");
...
class Destinations {
  ...
  init = async api => {
    try {
      ...
      destinations.forEach(destination => {
        const item = _utils_adapter__WEBPACK_IMPORTED_MODULE_0__["default"].adaptDestinationToClient(destination);
  ...
  #initValidationPattern = () => {
    const listOfCities = Array.from(this.#destinations.keys()).reduce((result, item) => {
      if (!result) {
  ...
  #initDestinationsOptionsTemplate = () => {
    this.#destinationOptionsTemplate = Array.from(this.#destinations.values()).map(item => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ RouteModel)
/* harmony export */ });
/* harmony import */ var _const__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../const */ "./src/const.js");
/* harmony import */ var _utils_abstract_observable__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/abstract-observable */ "./src/utils/abstract-observable.js");
/* harmony import */ var _utils_adapter__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/adapter */ "./src/utils/adapter.js");



class RouteModel extends _utils_abstract_observable__WEBPACK_IMPORTED_MODULE_1__["default"] {
  #events = [];
  #apiService = null;
  ...
  init = async () => {
    try {
      ...
      this.#events = events.map(event => _utils_adapter__WEBPACK_IMPORTED_MODULE_2__["default"].adaptEventToClient(event));
    } catch (error) {
      this.#events = [];
    }
  ...
  updateEvent = async (updateType, update) => {
    ...
    try {
      ...
      const updatedEvent = _utils_adapter__WEBPACK_IMPORTED_MODULE_2__["default"].adaptEventToClient(response);
  ...
  addEvent = async (updateType, update) => {
    try {
      ...
      const newEvent = _utils_adapter__WEBPACK_IMPORTED_MODULE_2__["default"].adaptEventToClient(response);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ RouteInfoPresenter)
/* harmony export */ });
/* harmony import */ var _render__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../render */ "./src/render.js");
/* harmony import */ var _view_route_info_view__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../view/route-info-view */ "./src/view/route-info-view.js");


class RouteInfoPresenter {
  #routeInfoView = null;
  init = events => {
    this.#routeInfoView = new _view_route_info_view__WEBPACK_IMPORTED_MODULE_1__["default"](events);
    this.#renderRouteInfo();
  };
  #renderRouteInfo = () => {
    const tripMainElement = document.querySelector(".trip-main");
    (0,_render__WEBPACK_IMPORTED_MODULE_0__.render)(tripMainElement, this.#routeInfoView, _render__WEBPACK_IMPORTED_MODULE_0__.RenderPosition.AFTERBEGIN);
  };
  destroy = () => {
    (0,_render__WEBPACK_IMPORTED_MODULE_0__.remove)(this.#routeInfoView);
  };
}

/***/ }),

/***/ "./src/presenter/route-point-new.js":
/*!******************************************!*\
  !*** ./src/presenter/route-point-new.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ RoutePointNewPresenter)
/* harmony export */ });
/* harmony import */ var _const__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../const */ "./src/const.js");
/* harmony import */ var _render__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../render */ "./src/render.js");
/* harmony import */ var _view_route_point_edit_view__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../view/route-point-edit-view */ "./src/view/route-point-edit-view.js");



class RoutePointNewPresenter {
  #routePointEdit = null;
  ...
  init = () => {
    this.#routePointEdit = new _view_route_point_edit_view__WEBPACK_IMPORTED_MODULE_2__["default"]();
    this.#handleSaveClick();
    this.#handleCancelClick();
    this.#renderRoutePointEdit();
  };
  destroy = () => {
    (0,_render__WEBPACK_IMPORTED_MODULE_1__.remove)(this.#routePointEdit);
    this.#routePointEdit = null;
  };
  #renderRoutePointEdit = () => {
    (0,_render__WEBPACK_IMPORTED_MODULE_1__.render)(this.#routePointListContainer, this.#routePointEdit, _render__WEBPACK_IMPORTED_MODULE_1__.RenderPosition.AFTERBEGIN);
  };
  #handleSaveClick = () => {
    this.#routePointEdit.setSaveButtonClickHandler(data => {
      this.#changeData(_const__WEBPACK_IMPORTED_MODULE_0__.UserAction.ADD_EVENT, _const__WEBPACK_IMPORTED_MODULE_0__.UpdateType.MINOR, data);
      this.destroy();
    });
  };
  #handleCancelClick = () => {
...
/* harmony export */ });
/* harmony import */ var _render__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../render */ "./src/render.js");
/* harmony import */ var _view_offers_view__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../view/offers-view */ "./src/view/offers-view.js");
/* harmony import */ var _view_offers_title_view__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../view/offers-title-view */ "./src/view/offers-title-view.js");
/* harmony import */ var _view_route_point_edit_view__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../view/route-point-edit-view */ "./src/view/route-point-edit-view.js");
/* harmony import */ var _view_route_point_view__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../view/route-point-view */ "./src/view/route-point-view.js");
/* harmony import */ var _view_offer_view__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../view/offer-view */ "./src/view/offer-view.js");
...
class RoutePointPresenter {
  #routePoint = null;
  #routePointEdit = null;
  #offerTitleView = new _view_offers_title_view__WEBPACK_IMPORTED_MODULE_2__["default"]();
  #offersView = new _view_offers_view__WEBPACK_IMPORTED_MODULE_1__["default"]();
  #routePointListContainer = null;
  #changeData = null;
  #changeMode = null;
  #event = null;
  ...
  init = event => {
    ...
    this.#routePoint = new _view_route_point_view__WEBPACK_IMPORTED_MODULE_4__["default"](event);
    this.#routePointEdit = new _view_route_point_edit_view__WEBPACK_IMPORTED_MODULE_3__["default"](event);
    ...
    if (this.#mode === Mode.DEFAULT) {
      (0,_render__WEBPACK_IMPORTED_MODULE_0__.replace)(this.#routePoint, prevRoutePoint);
    }

    if (this.#mode === Mode.EDITING) {
      (0,_render__WEBPACK_IMPORTED_MODULE_0__.replace)(this.#routePointEdit, prevRoutePointEdit);
    }

    this.#renderOffers(event);
    (0,_render__WEBPACK_IMPORTED_MODULE_0__.remove)(prevRoutePoint);
    (0,_render__WEBPACK_IMPORTED_MODULE_0__.remove)(prevRoutePointEdit);
  };
  destroy = () => {
    (0,_render__WEBPACK_IMPORTED_MODULE_0__.remove)(this.#routePoint);
    (0,_render__WEBPACK_IMPORTED_MODULE_0__.remove)(this.#routePointEdit);
  };
  #renderOffers = event => {
    ...
    if (filteredOffers.length > 0) {
      const favoriteButtonElement = this.#routePoint.element.querySelector(`.event__favorite-btn`);
      this.#renderOffersTitle(favoriteButtonElement);
      this.#renderOffersView(favoriteButtonElement);
      filteredOffers.forEach(offer => {
        const offerView = new _view_offer_view__WEBPACK_IMPORTED_MODULE_5__["default"](offer);
        (0,_render__WEBPACK_IMPORTED_MODULE_0__.render)(this.#offersView, offerView);
  ...
  #clearOfferViewList = () => {
    this.#offerViewList.forEach(offerView => {
      (0,_render__WEBPACK_IMPORTED_MODULE_0__.remove)(offerView);
    });
    this.#offerViewList = [];
  };
  #renderOffersTitle = container => {
    (0,_render__WEBPACK_IMPORTED_MODULE_0__.render)(container, this.#offerTitleView, _render__WEBPACK_IMPORTED_MODULE_0__.RenderPosition.BEFOREBEGIN);
  };
  #renderOffersView = container => {
    (0,_render__WEBPACK_IMPORTED_MODULE_0__.render)(container, this.#offersView, _render__WEBPACK_IMPORTED_MODULE_0__.RenderPosition.BEFOREBEGIN);
  };
  #renderRoutePoint = () => {
    (0,_render__WEBPACK_IMPORTED_MODULE_0__.render)(this.#routePointListContainer, this.#routePoint);
  };
  ...
  #handleFavoriteClick = () => {
    this.#routePoint.setFavoriteClickHandler(() => {
      this.#changeData(_const__WEBPACK_IMPORTED_MODULE_6__.UserAction.UPDATE_EVENT, _const__WEBPACK_IMPORTED_MODULE_6__.UpdateType.PATCH, { ...this.#event,
  ...
  #handleSaveClick = () => {
    this.#routePointEdit.setSaveButtonClickHandler(data => {
      this.#changeData(_const__WEBPACK_IMPORTED_MODULE_6__.UserAction.UPDATE_EVENT, _const__WEBPACK_IMPORTED_MODULE_6__.UpdateType.PATCH, data);
      this.#replaceEditToDefault();
    });
  };
  #handleDeleteClick = () => {
    this.#routePointEdit.setDeleteButtonClickHandler(data => {
      this.#changeData(_const__WEBPACK_IMPORTED_MODULE_6__.UserAction.DELETE_EVENT, _const__WEBPACK_IMPORTED_MODULE_6__.UpdateType.MINOR, data);
    });
  };
  resetView = () => {
    if (this.#mode !== Mode.DEFAULT) {
  ...
  #replaceEditToDefault = () => {
    (0,_render__WEBPACK_IMPORTED_MODULE_0__.replace)(this.#routePoint, this.#routePointEdit);
    this.#mode = Mode.DEFAULT;
  };
  #replaceDefaultToEdit = () => {
    (0,_render__WEBPACK_IMPORTED_MODULE_0__.replace)(this.#routePointEdit, this.#routePoint);
    this.#changeMode();
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ RoutePresenter)
/* harmony export */ });
/* harmony import */ var _render__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../render */ "./src/render.js");
/* harmony import */ var _const__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../const */ "./src/const.js");
/* harmony import */ var _view_filter_form_view__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../view/filter-form-view */ "./src/view/filter-form-view.js");
/* harmony import */ var _view_navigation_menu_view__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../view/navigation-menu-view */ "./src/view/navigation-menu-view.js");
/* harmony import */ var _view_route_point_list_view__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../view/route-point-list-view */ "./src/view/route-point-list-view.js");
/* harmony import */ var _view_sort_form_view__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../view/sort-form-view */ "./src/view/sort-form-view.js");
/* harmony import */ var _route_point__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./route-point */ "./src/presenter/route-point.js");
/* harmony import */ var _route_info__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./route-info */ "./src/presenter/route-info.js");
/* harmony import */ var _view_add_button_view__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../view/add-button-view */ "./src/view/add-button-view.js");
/* harmony import */ var _route_point_new__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./route-point-new */ "./src/presenter/route-point-new.js");
...
class RoutePresenter {
  #routeModel = null;
  #navigationMenuView = new _view_navigation_menu_view__WEBPACK_IMPORTED_MODULE_3__["default"]();
  #filterFormView = new _view_filter_form_view__WEBPACK_IMPORTED_MODULE_2__["default"]();
  #sortFormView = null;
  #routePointListView = new _view_route_point_list_view__WEBPACK_IMPORTED_MODULE_4__["default"]();
  #addButtonView = new _view_add_button_view__WEBPACK_IMPORTED_MODULE_8__["default"]();
  #routePointPresenters = new Map();
  #routeInfoPresenter = null;
  #routePointNewPresenter = null;
  #currentSortType = _const__WEBPACK_IMPORTED_MODULE_1__.SortType.Day;
  ...
  get events() {
    ...
    return _utils_utils__WEBPACK_IMPORTED_MODULE_10__.sort[this.#currentSortType](events);
  }

  init = () => {
    this.#routeInfoPresenter = new _route_info__WEBPACK_IMPORTED_MODULE_7__["default"]();
  ...
  #handleNewEventClick = () => {
    this.#addButtonView.setAddButtonClickHandler(() => {
      ...
      this.#routePointNewPresenter = new _route_point_new__WEBPACK_IMPORTED_MODULE_9__["default"](this.#routePointListView, this.#handleViewAction);
  ...
  #renderRoutePoints = () => {
    this.events.forEach(event => {
      const routePointPresenter = new _route_point__WEBPACK_IMPORTED_MODULE_6__["default"](this.#routePointListView, this.#handleViewAction, this.#handleModeChange);
  ...
  #renderNavigationMenu = () => {
    const navigationMenuWrapperElement = document.querySelector(".trip-controls__navigation");
    (0,_render__WEBPACK_IMPORTED_MODULE_0__.render)(navigationMenuWrapperElement, this.#navigationMenuView);
  };
  #renderFilterForm = () => {
    const filterFormWrapperElement = document.querySelector(".trip-controls__filters");
    (0,_render__WEBPACK_IMPORTED_MODULE_0__.render)(filterFormWrapperElement, this.#filterFormView);
  };
  #renderSortForm = () => {
    const tripEventsElement = document.querySelector(".trip-events");
    this.#sortFormView = new _view_sort_form_view__WEBPACK_IMPORTED_MODULE_5__["default"](this.#currentSortType);
    this.#sortFormView.setSortTypeChangeHandler(this.#handleSortTypeChange);
    (0,_render__WEBPACK_IMPORTED_MODULE_0__.render)(tripEventsElement, this.#sortFormView);
  };
  #renderAddButton = () => {
    const tripMainElement = document.querySelector(".trip-main");
    (0,_render__WEBPACK_IMPORTED_MODULE_0__.render)(tripMainElement, this.#addButtonView);
  };
  #renderRoutePointList = () => {
    const tripEventsElement = document.querySelector(".trip-events");
    (0,_render__WEBPACK_IMPORTED_MODULE_0__.render)(tripEventsElement, this.#routePointListView);
  };
  #handleViewAction = (actionType, updateType, update) => {
    switch (actionType) {
      case _const__WEBPACK_IMPORTED_MODULE_1__.UserAction.UPDATE_EVENT:
        this.#routeModel.updateEvent(updateType, update);
        break;

      case _const__WEBPACK_IMPORTED_MODULE_1__.UserAction.ADD_EVENT:
        this.#routeModel.addEvent(updateType, update);
        break;

      case _const__WEBPACK_IMPORTED_MODULE_1__.UserAction.DELETE_EVENT:
  ...
  #handleModelEvent = (updateType, data) => {
    switch (updateType) {
      case _const__WEBPACK_IMPORTED_MODULE_1__.UpdateType.PATCH:
      ...
      case _const__WEBPACK_IMPORTED_MODULE_1__.UpdateType.MAJOR:
        break;

      case _const__WEBPACK_IMPORTED_MODULE_1__.UpdateType.INIT:
  ...
  #closeCreationForm = () => {
    var _this$routePointNewPr;

    (_this$routePointNewPr = this.#routePointNewPresenter) === null || _this$routePointNewPr === void 0 ? void 0 : _this$routePointNewPr.destroy();
  };
}
...
const render = function (container, element) {
...
const replace = (newComponent, oldComponent) => {
  if (!(newComponent instanceof _view_abstract_view__WEBPACK_IMPORTED_MODULE_0__["default"] && oldComponent instanceof _view_abstract_view__WEBPACK_IMPORTED_MODULE_0__["default"])) {
...
class Adapter {
  static adaptEventToClient = event => {
    const offerType = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.getOfferTypeByName)(event["type"]);
    const offer = {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "formatDatePair": () => (/* binding */ formatDatePair),
/* harmony export */   "formatShortDate": () => (/* binding */ formatShortDate),
/* harmony export */   "getOfferTypeByName": () => (/* binding */ getOfferTypeByName),
...
/* harmony export */   "humanizeDateSpread": () => (/* binding */ humanizeDateSpread),
...
const humanizeDateSpread = (startDate, finishDate) => {
...
const formatShortDate = (date, isOnlyDay) => {
  const month = isOnlyDay ? `` : _const_js__WEBPACK_IMPORTED_MODULE_0__.MONTHS[date.getMonth()];
  const day = date.getDate();
  return `${month} ${day}`.trim();
};
const formatDatePair = (firstDate, secondDate) => {
...
const getOfferTypeByName = name => {
  return _const_js__WEBPACK_IMPORTED_MODULE_0__.offerTypes.find(item => {
...
const sort = {
  [_const_js__WEBPACK_IMPORTED_MODULE_0__.SortType.Day]: events => events.sort((a, b) => a.firstDate - b.firstDate),
  [_const_js__WEBPACK_IMPORTED_MODULE_0__.SortType.Price]: events => events.sort((a, b) => b.price - a.price),
  [_const_js__WEBPACK_IMPORTED_MODULE_0__.SortType.Time]: events => events.sort((a, b) => getTimeSpreadFromEvent(b) - getTimeSpreadFromEvent(a))
};
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "createAddButtonTemplate": () => (/* binding */ createAddButtonTemplate),
/* harmony export */   "default": () => (/* binding */ AddButtonView)
/* harmony export */ });
...
class AddButtonView extends _abstract_view__WEBPACK_IMPORTED_MODULE_0__["default"] {
  get template() {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "createFilterFormTemplate": () => (/* binding */ createFilterFormTemplate),
/* harmony export */   "default": () => (/* binding */ FilterFormView)
/* harmony export */ });
/* harmony import */ var _abstract_view__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-view */ "./src/view/abstract-view.js");
...
class FilterFormView extends _abstract_view__WEBPACK_IMPORTED_MODULE_0__["default"] {
  get template() {
...
/***/ "./src/view/navigation-menu-view.js":
/*!******************************************!*\
  !*** ./src/view/navigation-menu-view.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "createNavigationMenuTemplate": () => (/* binding */ createNavigationMenuTemplate),
/* harmony export */   "default": () => (/* binding */ NavigationMenuView)
/* harmony export */ });
/* harmony import */ var _abstract_view__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-view */ "./src/view/abstract-view.js");

const createNavigationMenuTemplate = () => `<nav class="trip-controls__trip-tabs  trip-tabs">
...
class NavigationMenuView extends _abstract_view__WEBPACK_IMPORTED_MODULE_0__["default"] {
  get template() {
...
/* harmony export */   "default": () => (/* binding */ OfferView)
/* harmony export */ });
/* harmony import */ var _abstract_view__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-view */ "./src/view/abstract-view.js");

const createOfferTemplate = _ref => {
  let {
    title,
    price
  } = _ref;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ OfferTitleView)
/* harmony export */ });
/* harmony import */ var _abstract_view__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-view */ "./src/view/abstract-view.js");
...
class OfferTitleView extends _abstract_view__WEBPACK_IMPORTED_MODULE_0__["default"] {
  get template() {
...
/* harmony export */   "default": () => (/* binding */ OffersView)
/* harmony export */ });
/* harmony import */ var _abstract_view__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-view */ "./src/view/abstract-view.js");
...
class OffersView extends _abstract_view__WEBPACK_IMPORTED_MODULE_0__["default"] {
  get template() {
...
const createRouteInfoTemplate = events => {
  const {
    ...
    result.price += event.price + event.offer.offers.filter(offer => offer.checked).reduce((acc, offer) => acc + offer.price, 0);
    return result;
  }, {
    places: [],
    finishDate: new Date(),
  ...
  const datePair = (0,_utils_utils__WEBPACK_IMPORTED_MODULE_0__.formatDatePair)(startDate, finishDate);
  const tripInfoTitle = places.length > 3 ? `${places[0]} &mdash; ... &mdash; ${places[places.length - 1]}` : `${places.join(` &mdash; `)}`;
...
class RouteInfoView extends _abstract_view__WEBPACK_IMPORTED_MODULE_1__["default"] {
  #events = null;
...
/***/ "./src/view/route-point-abstract-view.js":
/*!***********************************************!*\
  !*** ./src/view/route-point-abstract-view.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ RoutePointAbstractView)
/* harmony export */ });
/* harmony import */ var _abstract_view__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-view */ "./src/view/abstract-view.js");

class RoutePointAbstractView extends _abstract_view__WEBPACK_IMPORTED_MODULE_0__["default"] {
  _event = null;
...
/***/ "./src/view/route-point-edit-view.js":
/*!*******************************************!*\
  !*** ./src/view/route-point-edit-view.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "createPhotosTemplate": () => (/* binding */ createPhotosTemplate),
/* harmony export */   "createRollupButtonTempalte": () => (/* binding */ createRollupButtonTempalte),
/* harmony export */   "createRoutePointEditTemplate": () => (/* binding */ createRoutePointEditTemplate),
/* harmony export */   "default": () => (/* binding */ RoutePointEditView)
/* harmony export */ });
/* harmony import */ var _common_destinations__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../common/destinations */ "./src/common/destinations.js");
/* harmony import */ var _common_offers__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../common/offers */ "./src/common/offers.js");
...
const BLANK_EVENT = {
  offerType: (0,_utils_utils__WEBPACK_IMPORTED_MODULE_3__.getOfferTypeByName)("taxi"),
  offer: {
    type: "taxi",
    offers: []
  },
...
const createAvailableOfferTemplate = _ref => {
  let {
    id,
    title,
    price,
...
const createEventFieldDestinationTemplate = (type, destination) => {
  const validationPattern = _common_destinations__WEBPACK_IMPORTED_MODULE_0__["default"].getInstance().getValidationPattern();
  const destinationOptions = _common_destinations__WEBPACK_IMPORTED_MODULE_0__["default"].getInstance().getDestinationsOptionsTemplate();
...
const createEventFieldTimeTemplate = (startDate, finishDate) => {
  return `<div class="event__field-group event__field-group--time">
      ...
      <input
        ...
        value="${(0,_utils_utils__WEBPACK_IMPORTED_MODULE_3__.humanizeDateInput)(startDate)}"
      />
      &mdash;
      ...
      <input
        ...
        type="text"
        name="event-end-time"
        value="${(0,_utils_utils__WEBPACK_IMPORTED_MODULE_3__.humanizeDateInput)(finishDate)}"
      />
    </div>`;
};
...
const createRollupButtonTempalte = () => {
  return `<button class="event__rollup-btn" type="button">
      <span class="visually-hidden">Open event</span>
    </button>`;
};
const createRoutePointEditTemplate = _ref2 => {
  let {
    price,
    offerType,
    place,
  ...
  const type = `${(0,_utils_utils__WEBPACK_IMPORTED_MODULE_3__.upCaseFirst)(offerType.name)}`;
  const destination = `${(0,_utils_utils__WEBPACK_IMPORTED_MODULE_3__.upCaseFirst)(place.name)}`;
  ...
  return `<li class="trip-events__item">
      <form class="event event--edit" action="#" method="post">
        <header class="event__header">
          <div class="event__type-wrapper">
            ...
            <div class="event__type-list">
              ${createEventTypesTemplate(_const__WEBPACK_IMPORTED_MODULE_2__.offerTypes, offerType.name)}
            </div>
          </div>
        ...
        <section class="event__details">
          ${offer.offers.length > 0 ? createAvailableOffersTemplate(offer.offers) : ``}
...
class RoutePointEditView extends _smart_view__WEBPACK_IMPORTED_MODULE_4__["default"] {
  #datePickerStart = null;
  #datePickerFinish = null;

  constructor() {
    let event = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : BLANK_EVENT;
    super();

    if (event.newEvent) {
      event.offer.offers = _common_offers__WEBPACK_IMPORTED_MODULE_1__["default"].getInstance().getOffersByType("taxi");
      const [firstValue] = _common_destinations__WEBPACK_IMPORTED_MODULE_0__["default"].getInstance().getDestinations().values();
  ...
  setRollupClickHandler = callback => {
    ...
    this._callback.rollupClick = callback;
    (_this$element$querySe = this.element.querySelector(".event__rollup-btn")) === null || _this$element$querySe === void 0 ? void 0 : _this$element$querySe.addEventListener("click", this.#rollupClickHandler);
  };
  setSaveButtonClickHandler = callback => {
    this._callback.saveClick = callback;
    this.element.querySelector("form").addEventListener("submit", this.#saveButtonHandler);
  };
  ...
  #deleteButtonHandler = event => {
    ...
    this._callback.deleteClick(RoutePointEditView.parseStateToEvent(this._state));
  };
  #setInnerHandlers = () => {
    this.element.querySelector(".event__type-group").addEventListener("input", this.#typeInputHandler);
    this.element.querySelectorAll(".event__offer-checkbox").forEach(offerCheckbox => {
      offerCheckbox.addEventListener("input", this.#offerInputHandler);
    });
    this.element.querySelector("input[name=event-destination]").addEventListener("change", this.#destinationInputHandler);
  ...
  #destinationInputHandler = event => {
    ...
    if (event.target.validity.valid) {
      this.updateData({
        place: _common_destinations__WEBPACK_IMPORTED_MODULE_0__["default"].getInstance().getDestinationByName(event.target.value)
      });
    }
  };
  #typeInputHandler = event => {
    ...
    const offer = {
      type: value,
      offers: _common_offers__WEBPACK_IMPORTED_MODULE_1__["default"].getInstance().getOffersByType(value)
    };
    this.updateData({
      offerType: (0,_utils_utils__WEBPACK_IMPORTED_MODULE_3__.getOfferTypeByName)(value),
      offer
    });
  };
  ...
  #setDatePicker = () => {
    ...
    this.#datePickerStart = (0,flatpickr__WEBPACK_IMPORTED_MODULE_5__["default"])(this.element.querySelector(`input[name = event-start-time]`), {
    ...
    this.#datePickerFinish = (0,flatpickr__WEBPACK_IMPORTED_MODULE_5__["default"])(this.element.querySelector(`input[name = event-end-time]`), {
      dateFormat: `d/m/y H:i`,
      enableTime: true,
      time_24hr: true,
...
/***/ "./src/view/route-point-list-view.js":
/*!*******************************************!*\
  !*** ./src/view/route-point-list-view.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (/* binding */ RoutePointListView)
/* harmony export */ });
/* harmony import */ var _abstract_view__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-view */ "./src/view/abstract-view.js");
...
class RoutePointListView extends _abstract_view__WEBPACK_IMPORTED_MODULE_0__["default"] {
  get template() {
...
/* harmony export */ });
/* harmony import */ var _utils_utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/utils */ "./src/utils/utils.js");
/* harmony import */ var _route_point_abstract_view__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./route-point-abstract-view */ "./src/view/route-point-abstract-view.js");


const createRoutePointTemplate = _ref => {
  let {
    offerType,
    place,
    startDate,
  ...
  const shortDate = (0,_utils_utils__WEBPACK_IMPORTED_MODULE_0__.formatShortDate)(startDate);
  const eventTitle = `${(0,_utils_utils__WEBPACK_IMPORTED_MODULE_0__.upCaseFirst)(offerType.name)} ${offerType.action} ${place.name}`;
  return `<li class="trip-events__item">
      <div class="event">
        ...
        <div class="event__schedule">
          <p class="event__time">
            <time class="event__start-time" datetime="2019-03-18T12:25">
              ${(0,_utils_utils__WEBPACK_IMPORTED_MODULE_0__.humanizeTime)(startDate)}
            </time>
            &mdash;
            <time class="event__end-time" datetime="2019-03-18T13:35">
              ${(0,_utils_utils__WEBPACK_IMPORTED_MODULE_0__.humanizeTime)(finishDate)}
            </time>
          </p>
          <p class="event__duration">
            ${(0,_utils_utils__WEBPACK_IMPORTED_MODULE_0__.humanizeDateSpread)(startDate, finishDate)}
          </p>
        </div>
...
class RoutePointView extends _route_point_abstract_view__WEBPACK_IMPORTED_MODULE_1__["default"] {
  get template() {
...
class SmartView extends _abstract_view__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  updateData = (() => {
    ...
    return function (update) {
      let justDataUpdating = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "createSortFormTemplate": () => (/* binding */ createSortFormTemplate),
/* harmony export */   "default": () => (/* binding */ SortFormView)
/* harmony export */ });
/* harmony import */ var _const__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../const */ "./src/const.js");
/* harmony import */ var _abstract_view__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./abstract-view */ "./src/view/abstract-view.js");
...
const getDisabledSortTypesAttribute = sortType => {
  if (sortType === _const__WEBPACK_IMPORTED_MODULE_0__.SortType.Event || sortType === _const__WEBPACK_IMPORTED_MODULE_0__.SortType.Offers) {
    return `disabled`;
  }
...
const createSortFormTemplate = currentSortType => {
  return `<form class="trip-events__trip-sort trip-sort" action="#" method="get">
      ${Object.values(_const__WEBPACK_IMPORTED_MODULE_0__.SortType).map(sortType => {
    return `<div class="trip-sort__item trip-sort__item--${sortType}">
              ...
              <label class="trip-sort__btn" for="sort-${sortType}">
                ${(0,_utils_utils__WEBPACK_IMPORTED_MODULE_2__.upCaseFirst)(sortType)}
              </label>
            </div>`;
  }).join("")}
    </form>`;
};
class SortFormView extends _abstract_view__WEBPACK_IMPORTED_MODULE_1__["default"] {
...
/*!*********************!*\
  ...
  \*********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _api_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./api-service */ "./src/api-service.js");
/* harmony import */ var _common_destinations__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./common/destinations */ "./src/common/destinations.js");
/* harmony import */ var _common_offers__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./common/offers */ "./src/common/offers.js");
/* harmony import */ var _const__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./const */ "./src/const.js");
/* harmony import */ var _model_route_model__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./model/route-model */ "./src/model/route-model.js");
/* harmony import */ var _presenter_route__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./presenter/route */ "./src/presenter/route.js");
...
const api = new _api_service__WEBPACK_IMPORTED_MODULE_0__["default"](_const__WEBPACK_IMPORTED_MODULE_3__.END_POINT, _const__WEBPACK_IMPORTED_MODULE_3__.AUTHORIZATION);
const routeModel = new _model_route_model__WEBPACK_IMPORTED_MODULE_4__["default"](api);
const routePresenter = new _presenter_route__WEBPACK_IMPORTED_MODULE_5__["default"](routeModel);
Promise.all([_common_destinations__WEBPACK_IMPORTED_MODULE_1__["default"].getInstance().init(api), _common_offers__WEBPACK_IMPORTED_MODULE_2__["default"].getInstance().init(api)]).then(() => {
  routePresenter.init();
});
})();
